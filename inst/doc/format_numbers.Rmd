...
The units R package (website: [Measurement Units for R](https://r-quantities.github.io/units/)) provides measurement units for R vectors, converting vectors of class "numeric" to class "units" [@Pebesma+Mailund+Hiebert:2016:units]. For example
